...
namespace StatNav.IntegrationTests
{
    ...
    {      
        public static void DeletePackagesTest()
        {
            ...
            Assert.IsTrue(AppDriver.driver.PageSource.Contains("Are you sure you want to remove this Package Container? Removing this package will also remove all its marketing asset packages, experiments and variants"));
